...
repositories {
    ...
    maven("https://veeva.github.io/vault-api-library/maven")
}
...
tasks {
    ...
    withType<GenerateParserTask> {
        sourceFile.set(file("src/main/java/com/veeva/vault/toolbox/intellij/language/Mdl.bnf"))
        targetRootOutputDir.set(file("src/main/gen"))
        pathToParser.set("/com/veeva/vault/toolbox/intellij/language/parser/MdlParser.java")
        pathToPsiRoot.set("/com/veeva/vault/toolbox/intellij/language/psi")
        purgeOldFiles.set(true)
    }

    withType<GenerateLexerTask> {
        sourceFile.set(file("src/main/java/com/veeva/vault/toolbox/intellij/language/Mdl.flex"))
        targetOutputDir.set(file("src/main/gen/com/veeva/vault/toolbox/intellij/language"))
        purgeOldFiles.set(true)
    }
}
