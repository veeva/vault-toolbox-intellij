...
public class MdlNewAttributeImpl extends ASTWrapperPsiElement implements MdlNewAttribute {

  public MdlNewAttributeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitNewAttribute(this);
  }
