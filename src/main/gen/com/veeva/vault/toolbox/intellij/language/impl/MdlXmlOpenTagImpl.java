...
public class MdlXmlOpenTagImpl extends ASTWrapperPsiElement implements MdlXmlOpenTag {

    public MdlXmlOpenTagImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull MdlVisitor visitor) {
        visitor.visitXmlOpenTag(this);
    }
