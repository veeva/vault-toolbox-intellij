...
public class MdlRecordRenameCommandImpl extends ASTWrapperPsiElement implements MdlRecordRenameCommand {

  public MdlRecordRenameCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitRecordRenameCommand(this);
  }
