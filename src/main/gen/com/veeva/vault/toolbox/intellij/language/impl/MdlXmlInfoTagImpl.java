...
public class MdlXmlInfoTagImpl extends ASTWrapperPsiElement implements MdlXmlInfoTag {

    public MdlXmlInfoTagImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull MdlVisitor visitor) {
        visitor.visitXmlInfoTag(this);
    }
