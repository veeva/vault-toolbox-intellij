...
public class MdlRecordDropCommandImpl extends ASTWrapperPsiElement implements MdlRecordDropCommand {

  public MdlRecordDropCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitRecordDropCommand(this);
  }
