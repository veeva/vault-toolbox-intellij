...
public class MdlComponentDropCommandImpl extends ASTWrapperPsiElement implements MdlComponentDropCommand {

  public MdlComponentDropCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitComponentDropCommand(this);
  }
