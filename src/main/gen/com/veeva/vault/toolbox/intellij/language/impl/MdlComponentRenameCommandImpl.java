...
public class MdlComponentRenameCommandImpl extends ASTWrapperPsiElement implements MdlComponentRenameCommand {

  public MdlComponentRenameCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitComponentRenameCommand(this);
  }
