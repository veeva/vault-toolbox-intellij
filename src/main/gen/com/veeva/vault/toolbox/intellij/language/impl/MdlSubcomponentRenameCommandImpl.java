...
public class MdlSubcomponentRenameCommandImpl extends ASTWrapperPsiElement implements MdlSubcomponentRenameCommand {

  public MdlSubcomponentRenameCommandImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitSubcomponentRenameCommand(this);
  }
