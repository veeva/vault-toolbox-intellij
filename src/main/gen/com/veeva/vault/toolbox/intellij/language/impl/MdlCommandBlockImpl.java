...
public class MdlCommandBlockImpl extends ASTWrapperPsiElement implements MdlCommandBlock {

    public MdlCommandBlockImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    @NotNull
    public List<MdlCommandItem> getCommandItemList() {
        return PsiTreeUtil.getChildrenOfTypeAsList(this, MdlCommandItem.class);
    }
