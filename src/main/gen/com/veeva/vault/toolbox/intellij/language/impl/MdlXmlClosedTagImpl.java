...
public class MdlXmlClosedTagImpl extends ASTWrapperPsiElement implements MdlXmlClosedTag {

  public MdlXmlClosedTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MdlVisitor visitor) {
    visitor.visitXmlClosedTag(this);
  }
