 ...
 */
public class ConfigurationReportTask extends ToolboxTask {
    private static final Logger logger = LoggerFactory.getLogger(ConfigurationReportTask.class);
    ...
    /**
     * Constructs a new ConfigurationReportTask.
     *
     * @param project the IntelliJ project, may be {@code null}
     * @param options the configuration options for the report request
     */
    public ConfigurationReportTask(@Nullable Project project, ConfigurationReport.Options options) {
